...
* [Simple VPC](https://github.com/aws-terraform-stacks/terraform-aws-vpc/tree/master/examples/simple-vpc)
* [Complete VPC](https://github.com/aws-terraform-stacks/terraform-aws-vpc/tree/master/examples/complete-vpc)
* [Manage Default VPC](https://github.com/aws-terraform-stacks/terraform-aws-vpc/tree/master/examples/manage-default-vpc)
* Few tests and edge cases examples: [#46](https://github.com/aws-terraform-stacks/terraform-aws-vpc/tree/master/examples/issue-46-no-private-subnets), [#44](https://github.com/aws-terraform-stacks/terraform-aws-vpc/tree/master/examples/issue-44-asymmetric-private-subnets), [#108](https://github.com/aws-terraform-stacks/terraform-aws-vpc/tree/master/examples/issue-108-route-already-exists)
...
1. Install [rvm](https://rvm.io/rvm/install) and the ruby version specified in the [Gemfile](https://github.com/aws-terraform-stacks/terraform-aws-vpc/tree/master/Gemfile).
